    ...
    def test_Hotel_details(self):
        try:
            ...
            select_rooms = WebDriverWait(self.driver, 10).until(
                EC.element_to_be_clickable((By.XPATH, '//span[@data-test="SelectRoomButton_span"]'))
            )
            ...
            time.sleep(2)
            # Scroll
            BookNow_Button = self.driver.find_element(By.XPATH, "(//span[contains(text(),'Book now')])[1]")
